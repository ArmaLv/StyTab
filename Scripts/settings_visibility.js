document.addEventListener("DOMContentLoaded", function() {
    ...
    const toggleSpotifyCheckbox = document.getElementById("toggle-spotify");
    ...
    const spotifyVisible = localStorage.getItem("spotifyVisible") === 'true';
    ...
    saveButton.addEventListener("click", () => {
        ...
        const newSpotifyVisible = toggleSpotifyCheckbox ? toggleSpotifyCheckbox.checked : true;
        ...
        localStorage.setItem("spotifyVisible", newSpotifyVisible);
